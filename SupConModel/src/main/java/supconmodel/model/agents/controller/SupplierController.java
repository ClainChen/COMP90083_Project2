    ...
    public void init(GoodController goodController, ConsumerController consumerController){
        ...
        for (int i = 0; i < Parameters.num_suppliers; i++) {
            ...
            for (int j = 0; j < Parameters.goods_per_supplier; j++) {
                ...
                switch (dGood.type) {
                    case BASIC -> dGood.inventory = Parameters.init_basic_inventory;
                    case CONVENIENCE -> dGood.inventory = Parameters.init_convenient_inventory;
                    case LUXURY -> dGood.inventory = Parameters.init_luxury_inventory;
                }
